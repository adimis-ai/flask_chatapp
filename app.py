...
def save_chat_message(sender_username, receiver_username, message_content):
    try:
        ...
        # You can choose to raise the exception or handle it in a way that makes sense for your application.

# Function to retrieve chat history for a specific sender and receiver
...
def register():
    ...
    if create_user(new_user.to_dict()):
...
def get_user_chat_history():
    try:
        ...
        chat_history = get_chat_history(sender_username, receiver_username)
...
def handle_send_message_event(data):
    ...
    if sender and receiver:
        ...
        if receiver['online']:
            ...
            save_chat_message(sender_username, receiver_username, message_content)
